        ...
        <S.Container>
          ...
          <MotionReveal delay={0.6}>
            <section>
              ...
              <ul>
                <li>
                  <strong>Desenvolvimento profissional:</strong> oportunidades
                  de aprendizado contínuo e crescimento técnico.
                </li>
                <li>
                  <strong>Atuação em diferentes segmentos:</strong> contato
                  direto com demandas reais da indústria, ampliando a
                  experiência profissional.
                </li>
                <li>
                  <strong>Ambiente colaborativo:</strong> valorizamos o
                  respeito, a comunicação clara e o trabalho em equipe.
                </li>
                <li>
                  <strong>Estrutura organizada:</strong> processos bem definidos
                  e foco em eficiência operacional.
                </li>
              </ul>
            </section>
          </MotionReveal>
          <MotionReveal delay={0.8}>
            <section>
              ...
              <ul>
                <li>
                  interesse em soluções industriais e atendimento técnico;
                </li>
          ...
          <MotionReveal delay={0.9}>
            <section>
              ...
              <p>
                ...
                <strong> consulter@consultersolucoes.com.br</strong> com o
                assunto
                <em> “Trabalhe na Consulter”</em>.
              </p>
              <p>
                Informe no corpo do e-mail a área de interesse e um breve resumo
                do seu perfil profissional. Caso haja uma oportunidade
                compatível, entraremos em contato para as próximas etapas.
              </p>
            </section>
          </MotionReveal>
          ...
          <MotionReveal delay={1}>
            <section>
              ...
              <p>
                ...
                crescimento da empresa está diretamente ligado ao crescimento
                das pessoas. Se você busca desafios, aprendizado e um ambiente
                onde seu trabalho faz a diferença, queremos conhecer você.
              </p>
            </section>
          </MotionReveal>
        </S.Container>
