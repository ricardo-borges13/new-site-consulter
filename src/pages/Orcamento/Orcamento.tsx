...
import { SectionOrcamento } from '../../components/SectionOrcamento/SectionOrcamento';
import { Map } from '../../components/Sections/SectionMap/Map/Map'
  ...
  return (
    <>
      ...
      <S.ContainerMap>
        ...
        <p>Estamos em Belo Horizonte – MG, com fácil acesso para atendimento regional e retirada de materiais quando necessário.</p>
        </header>
        <Map src={MAP_SRC} />
        <a
